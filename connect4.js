...
document.querySelector('button').addEventListener('click', function(e){
  let p1c = document.querySelector('#p1-color').value;
  let p2c = document.querySelector('#p2-color').value;
  if (p1c === p2c){
    alert('Players cannot be the same color!')
  } else {
    let p1 = new Player(p1c);
    let p2 = new Player(p2c);
